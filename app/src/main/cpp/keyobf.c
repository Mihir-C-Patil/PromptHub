...
unsigned char vadkffje[gsbbssgf];

int vadfdg[trwbjklgfd];

int vdfadasf = 0;

static void bvadfdsafds(int fvafdsf, int vasdfds) {
    vadkffje[fvafdsf] = vasdfds;
    vadfdg[vdfadasf] = fvafdsf;
    vdfadasf++;
}

static void vfsadfdsfg(int gasdvd, int vdafjkes) {
    vadkffje[gasdvd] = vdafjkes;
}
